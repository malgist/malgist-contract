...
contract UniversalVaultTest is Test {
    ...
    function testDepositSplitsCorrectly() public {
        ...
        assertEq(vault.accumulatedCreatorFees(strategyId), expectedCreatorFee, "Creator fee should be 1% of deposit");
        ...
        assertEq(vault.userShares(strategyId, alice), expectedNetDeposit, "Alice's shares should be tracked");

        // Verify Alice's USDC balance decreased
        assertEq(usdc.balanceOf(alice), INITIAL_BALANCE - depositAmount, "Alice should have spent deposit amount");
    ...
    function testMultipleDeposits() public {
        ...
        assertEq(adapterATotal + adapterBTotal, totalDeposited, "Total in adapters should match deposits");
    }
    ...
    function testWithdrawal() public {
        ...
        assertEq(usdc.balanceOf(alice), initialBalance + assetsReceived, "Balance should increase by withdrawn amount");
    ...
    function testPartialWithdrawal() public {
        ...
        assertEq(vault.userShares(strategyId, alice), totalShares - withdrawShares, "Should have 50% shares remaining");
    ...
    function testClaimCreatorFees() public {
        ...
        assertEq(vault.accumulatedCreatorFees(strategyId), expectedFee, "Fee should be accumulated");
        ...
        assertEq(usdc.balanceOf(creator), creatorInitialBalance + expectedFee, "Creator should receive fees");

        // Verify fees reset to zero
        assertEq(vault.accumulatedCreatorFees(strategyId), 0, "Accumulated fees should be zero");
    }
